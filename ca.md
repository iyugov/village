...
### Настройка безопасности сервера центра сертификации

#### Настройка доступа на сервер центра сертификации по ключу
...
7. Выполним копирование сгенерированного ключа на сервер "CA":

    ```sh
    ssh-copy-id -i ~/.ssh/id_ca user@ca.village
    ```

8. Выполним вход по ключу:

    ```sh
    ssh -i ~/.ssh/id_ca user@ca.village
    ```
...
#### Настройка fail2ban на сервере центра сертификации
...
#### Настройка отправки уведомлений о блокировках доступа на сервер центра сертификации через локальный почтовый сервер
