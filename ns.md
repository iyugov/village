# Создание хоста сервера имён

## Описание

Создаётся DHCP-сервер на базе Ubuntu Server 24.04 с RAID 1. Сервер имеет адрес 10.0.1.4/24. Сервер имён для самого этого сервера (вышестоящий) имеет адрес 192.168.1.1 в сети базовой системы.
...
5. На сервере "DHCP" откроем файл настроек сервера DHCP:
